...
# Directives
add-highlighter shared/z80/code/ regex ((^|\s+)[.#](area|ascii|asciiz|asciip|block|db|dw|byte|define|elif|endif|end|else|elseif|equ|equate|export|fill|if|ifdef|ifndef|import|include|incbin|list|macro|endmacro|nolist|org|printf|!))\b 0:type

# Registers
add-highlighter shared/z80/code/ regex \b(af'|(af|bc|de|hl|ix|iy|sp|pc|i|r|ixh|ixl|iyh|iyl|a|b|c|d|e|f|h|l)\b) 0:variable

# Condition codes
add-highlighter shared/z80/code/ regex \b(z|nz|c|nc|po|pe|p|m)\b 0:variable
